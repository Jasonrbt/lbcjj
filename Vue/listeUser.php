...
<table border="1" cellpadding="8">
    ...
    <?php foreach ($users as $user): ?>
        <tr>
            ...
            <td>
                <a href="index.php?action=deleteUser&id=<?= $user['ID_USER'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?');">Archiver</a>
            </td>
        </tr>
    <?php endforeach; ?>
